...
from models.stylegan_paddle import G_synthesis,G_mapping
from models.utils.SphericalOptimizer import SphericalOptimizer
from pathlib import Path
import numpy as np
import time
import paddle
from models.loss.loss import LossBuilder
from functools import partial
from models.utils.drive import open_url
...
class PULSE(paddle.nn.Layer):
    def __init__(self, cache_dir, batch_size, verbose=True):
        ...
        f=paddle.load("models/cache/styleGan.pdparams")
        ...
        if Path("models/cache/gaussian_fit").exists():
            self.gaussian_fit = paddle.load("models/cache/gaussian_fit")
        else:
